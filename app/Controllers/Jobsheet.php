        ...
        if (!$this->validation->withRequest($this->request)->run()) {
            ...
            if (!empty($sheetData)) {
                for ($i = 1; $i < count($sheetData); $i++) {
                    ...
                    $project_cost = !empty($sheetData[$i][22]) ? $sheetData[$i][22] : '0';
                    $invoice_amount = !empty($sheetData[$i][23]) ? $sheetData[$i][23] : '0';
                    $balance_amount = !empty($sheetData[$i][24]) ? $sheetData[$i][24] : '0';
