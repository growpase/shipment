                    ...
                    if (response.status == true) {
                        if (response.log && response.log.length > 0) {
                            ...
                            <table border="1" style="width: 100%; text-align: left; font-size: 14px;">
                                <thead>
                                    <tr>
                                        <th style="padding: 8px;">Delivery Note ID</th>
                                ...
                                <tbody>
                                    ${response.log
                                        .map(
                                            (log) =>
                                                `<tr>
                                                    <td style="padding: 8px;">${log.deliverynoteid}</td>
                            ...
                            document.getElementById("downloadLog").addEventListener("click", () => {
                                let logContent = response.log
                                    .map((log) => `Delivery Note ID: ${log.deliverynoteid}, Reason: ${log.reason}`)
                                    .join("\n");
                                ...
                                link.download = "DeliveryNote_logs.txt";
                                link.click();
                            });
